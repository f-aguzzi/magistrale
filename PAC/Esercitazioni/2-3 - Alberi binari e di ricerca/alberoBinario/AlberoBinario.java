...
public interface AlberoBinario {
	...
	/**
	 * Restituisce il livello di un dato nodo. La profondità della radice è
	 * zero, quella degli altri nodi è 1 + il livello del nodo padre.
	 * 
	 * @param v
	...
	/**
	 * Restituisce l'altezza dell'albero. Se l'albero è nullo, l'altezza è
	 * convenzionalmente posta pari a -1; la sola radice ha altezza 0; ogni
	 * livello diverso dalla radice aumenta di 1 il livello.
	 * 
	...
	/**
	 * Restituisce il numero di nodi interni (non foglie) dell'albero.
	 * 
	...
	/**
	 * Restituisce true se l'albero è uguale ad un altro albero.
	 * 
	 * @param anotherTree
	 * @return se l'albero è uguale ad anotherTree
	 */
	...
	/**
	 * Cerca l'elemento elem dentro l'albero. Se l'albero è vuoto,
	 * restituisce false. La ricerca si ferma alla prima istanza trovata.
	 * 
	 * @param elem
	 * @return true se elem viene trovato
	 */
	public boolean search(Object elem);
	
	/**
	 * Cerca i nodi cardine, ovvero quei nodi per i quali la profondità è pari
	 * all'altezza del sottoalbero di cui essi sono radice.
	 * 
	 * @return la lista dei nodi cardine
	 */
